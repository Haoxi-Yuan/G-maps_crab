...
private struct Config {
    ...
    // Atlas was retired in 2026. Its last adapter is preserved under
    // archive/atlas/monitor; the daily monitor no longer opens that endpoint.
    var atlasHost = ""
    var atlasRoot = ""
...
private final class RootView:NSView {
    ...
    private func refreshEndpoint(){
        ...
        endpointLabel.stringValue=stage == .resources ? "\(chark)  \(strix)" : "\(local)  \(chark)  \(strix)"
    }
